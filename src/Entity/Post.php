...
class Post
{
    const TYPES = ['💻 Programacion' => '💻 Programacion', '🤣 Humor' => '🤣 Humor', '🗣️ Aporte' => '🗣️ Aporte', '🤔 Opinion' => '🤔 Opinion'];
    ...
    {
        //add los atri de la entidad para crear correctamente el construc
        $this->title = $title;
        $this->type = $type;
        $this->description = $description;
        $this->file = $file;
        $this->creation_date = new \DateTime(); //lo inicializamos aca, al llamar un obj no tenemos que pasarle este param
        $this->url = $url;
